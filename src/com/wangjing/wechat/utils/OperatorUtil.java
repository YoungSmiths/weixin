...
public class OperatorUtil {
	...
	public String checkTextIsVerificationCode(String text) {

		Connection conn = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
		conn = new DBCPConnection().getConnection();
		String selectSql = "select * from VerificationCode where code='" + text + "'";
		if (conn == null) {
			return "连接数据库失败";
		} else {
			try {
